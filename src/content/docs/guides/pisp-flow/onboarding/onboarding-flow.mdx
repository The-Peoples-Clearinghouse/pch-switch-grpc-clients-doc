...
→ Ver implementación: [Responder consulta de cuentas del cliente](/pch-switch-grpc-clients-doc/guides/pisp-flow/get-customer-accounts-handler/)
...
→ Ver implementación: [Iniciar onboarding de cliente](/pch-switch-grpc-clients-doc/guides/pisp-flow/onboarding/initiate-onboard-handler/)
...
→ Ver implementación: [Generar nuevo OTP](/pch-switch-grpc-clients-doc/guides/pisp-flow/onboarding/new-otp-token-handler/)
...
→ Ver implementación: [Confirmar onboarding de cliente](/pch-switch-grpc-clients-doc/guides/pisp-flow/onboarding/try-confirm-onboard-handler/)
...
→ Ver implementación: [Dar de baja a un cliente](/pch-switch-grpc-clients-doc/guides/pisp-flow/onboarding/offboard-account-handler/)
